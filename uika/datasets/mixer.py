...
class MixerDataset(torch.utils.data.Dataset):
    ...
    def _dataset_fn(subset_config: dict, split: str):
        ...
        elif name == "mv_video_head":
            from .mv_video_head import MV_VideoHeadDataset
            dataset_cls = MV_VideoHeadDataset
    ...
    def __getitem__(self, idx):
        ...
        real_idx_tuple = (real_idx, *idx_tuple[1:]) if idx_tuple else real_idx
        return self.subsets[subset_idx][real_idx_tuple]
